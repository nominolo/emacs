...
(defun golden-braid-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (darcsum-whitespace-ateol-face ((t (:background "red4"))))
     ...
     (diff-file-header ((t (:foreground "gray90"))))
     (diff-file-header-face ((t (:foreground "gray90"))))
     (diff-function ((t (nil))))
     (diff-function-face ((t (nil))))
     (diff-header ((t (nil))))
     (diff-header-face ((t (nil))))
     (diff-hunk-header ((t (:background "gray10"))))
     (diff-hunk-header-face ((t (:background "gray10"))))
     (diff-index ((t (nil))))
     ...
     (gamegrid-face-*Tetris* ((t (:stipple nil :background "gray20" :foreground "gray70" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :family "apple-monaco"))))
     ...
     (secondary-selection ((t (:background "aquamarine4"))))
     ...
     (senator-momentary-highlight-face ((t (:foreground "lightsteelblue1" :background "slateblue4"))))
